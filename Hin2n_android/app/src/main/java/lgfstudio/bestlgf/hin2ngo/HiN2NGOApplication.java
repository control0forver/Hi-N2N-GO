package lgfstudio.bestlgf.hin2ngo;
...
import lgfstudio.bestlgf.hin2ngo.storage.db.base.DaoMaster;
import lgfstudio.bestlgf.hin2ngo.storage.db.base.DaoSession;
...
public class HiN2NGOApplication extends MultiDexApplication {
    ...
    //静态单例
    public static HiN2NGOApplication instance;
    ...
    public static HiN2NGOApplication getInstance() {
        return instance;
    }
