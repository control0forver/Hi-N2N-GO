package lgfstudio.bestlgf.hin2ngo.service;
...
import lgfstudio.bestlgf.hin2ngo.activity.MainActivity;
import lgfstudio.bestlgf.hin2ngo.event.*;
import lgfstudio.bestlgf.hin2ngo.model.EdgeCmd;
...
import lgfstudio.bestlgf.hin2ngo.tool.LogFileObserver;
import lgfstudio.bestlgf.hin2ngo.tool.ThreadUtils;

import static lgfstudio.bestlgf.hin2ngo.model.EdgeStatus.RunningStatus.DISCONNECT;
import static lgfstudio.bestlgf.hin2ngo.model.EdgeStatus.RunningStatus.SUPERNODE_DISCONNECT;
import static lgfstudio.bestlgf.hin2ngo.tool.N2nTools.getIpAddrPrefixLength;
import static lgfstudio.bestlgf.hin2ngo.tool.N2nTools.getRoute;
...
public class N2NService extends VpnService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String CHANNEL_ONE_ID = "lgfstudio.bestlgf.hin2ngo";
            ...
            NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this,CHANNEL_ONE_ID)
                    ...
                    .setContentText(String.format(getString(R.string.f_service_is_running), getString(R.string.app_name)))
