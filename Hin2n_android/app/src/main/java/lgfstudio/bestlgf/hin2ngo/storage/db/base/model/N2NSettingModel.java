package lgfstudio.bestlgf.hin2ngo.storage.db.base.model;
...
public class N2NSettingModel /*implements Parcelable*/ {
    ...
    boolean headerEnc;
@Generated(hash = 1509296310)
public N2NSettingModel(Long id, int version, String name, int ipMode, String ip,
        String netmask, String community, boolean hasPassword, String password,
        String devDesc, String superNode, boolean moreSettings,
        String superNodeBackup, String macAddr, int mtu, String localIP,
        int holePunchInterval, boolean resoveSupernodeIP, int localPort,
        boolean allowRouting, boolean dropMuticast, boolean useHttpTunnel,
        int traceLevel, boolean isSelcected, String gatewayIp, String dnsServer,
